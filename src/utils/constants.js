const API_URLS = {
    ...
    testPositivity: 'https://services3.arcgis.com/66aUo8zsujfVXRIT/arcgis/rest/services/colorado_covid19_laboratory_positivity_data/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json',
}
